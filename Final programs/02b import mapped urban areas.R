...
# Author: Evan Christo
# Filename: 02b import mapped urban areas
...
#### IMPORT AND CLEAN ####
  ...
  # Get objects
  objects <- gcs_list_objects(bucket = "ee-51910", prefix = "02 urban")
  files <- objects$name
  mapped <- files %>% 
...
#### SAVE ####
  ...
  # Save to .r file
  saveRDS(mapped, file = "02 intermediate/02 urban areas mapped to admin boundaries.r")