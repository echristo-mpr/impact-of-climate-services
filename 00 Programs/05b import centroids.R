...
# Author: Evan Christo
# Filename: 05b import urban area centroids
...
#### IMPORT AND CLEAN ####
  ...
  # Get objects
  objects <- gcs_list_objects(bucket = "ee-51910", prefix = "05 urban")
  files <- objects$name
  centroids <- files %>% 
...
#### SAVE ####
  ...
  # Save to .r file
  saveRDS(centroids, file = "02 intermediate/05 urban areas centroids.r")
